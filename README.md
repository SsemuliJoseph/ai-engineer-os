...
- Learn to build and evaluate AI systems
...
├── logs/                 # Daily build-in-public learning logs
├── src/                  # Project source code
├── check_env.py          # Development environment checker
├── test_setup.py         # Pytest smoke test
